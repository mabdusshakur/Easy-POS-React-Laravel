...
function SaleCreate() {
    ...
    // ---------------- Calculating total sum of Invoice items function ----------------
    ...
    // ---------------- Add Product to invoice function ----------------
    function add() {
    ...
    async function ProductList() {
        ...
        res.forEach(function (item, index) {
            let row = `<tr class="text-xs">
                        <td> <img class="w-10" src="${item['img_url']}" style="width:55px;"/> ${item['name']} ($ ${item['price']})</td>
                    ...
                    <div className="h-100 rounded-3 bg-white p-3 shadow-sm">
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <p>
                                    <button className="btn btn-outline-success my-3 w-40" onClick={createInvoice}>Confirm</button>
                                </p>
                            </div>
