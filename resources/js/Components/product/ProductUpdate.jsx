...
const ProductUpdate = forwardRef((props, ref) => {
    ...
    // ---------------- Fill up category Drop-Down function ----------------
    ...
    // ---------------- Fill Up Old Product Details function ----------------
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 p-1">
                                        ...
                                        <br />
                                        <img className="w-25" id="oldImg" src="images/default.jpg" />
                                        <br />
                    ...
                    <div className="modal-footer">
                        <button className="btn btn-outline-dark" id="update-modal-close" data-bs-dismiss="modal" aria-label="Close">Close</button>
                        <button className="btn btn-outline-success" id="update-btn" onClick={update}>Update</button>
                    </div>
