            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 p-1">
                                        ...
                                        <br />
                                        <img className="w-25" id="newImg" src="images/default.jpg" />
                                        <br />
                    ...
                    <div className="modal-footer">
                        <button className="btn btn-outline-dark mx-2" id="modal-close" data-bs-dismiss="modal" aria-label="Close">Close</button>
                        <button className="btn btn-outline-success" id="save-btn" onClick={Save}>Save</button>
                    </div>
                </div>
            </div>
        </div>
