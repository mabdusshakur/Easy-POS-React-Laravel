...
const CustomerUpdate = forwardRef((props, ref) => {
    ...
    // ---------------- Fill up Old Customer Details function ----------------
            ...
            <div className="modal-dialog modal-md modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button className="btn btn-outline-dark" id="update-modal-close" data-bs-dismiss="modal" aria-label="Close" onClick={closeUpdateModal}>Close</button>
